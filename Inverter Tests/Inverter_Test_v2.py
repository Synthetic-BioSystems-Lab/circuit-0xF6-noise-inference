# -*- coding: utf-8 -*-
"""
Created on Mon Aug 18 18:52:54 2025
...
repressor1 = Species('repressor1',  material_type='protein', attributes=['input'])
repressor2 = Species('repressor2',  material_type='protein', attributes=['input'])
...
# Promoter = CombinatorialPromoter('Promoter', regulators = [repressor1, repressor2], leak = True,
#                                  tx_capable_list= [[repressor1]], parameters = component_parameters)

Promoter = RegulatedPromoter('Promoter',  regulators = [repressor1, repressor2], leak=True, 
...
x_lst = np.linspace(0, 10, 100)
x0 = {construct_0.get_species():1}

max_conc = 10
num_val = 11

sim.heatmap(x0, timepoints, max_conc, num_val, repressor1, repressor2, 'protein_A_degtagged', 
            xlabel = 'repressor2', ylabel = 'repressor1')
